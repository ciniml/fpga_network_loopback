...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set HD_GPIO_0 [ create_bd_port -dir O HD_GPIO_0 ]

  # Create instance: axi_dma_network, and set properties
...
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_master_M00_AXI] [get_bd_intf_pins smartconnect_master/M00_AXI] [get_bd_intf_pins system_ila_axi/SLOT_4_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_master_M01_AXI [get_bd_intf_pins debug_bridge_inst/S_AXI] [get_bd_intf_pins smartconnect_master/M01_AXI]
  ...
  connect_bd_net -net blink_led_blink_out [get_bd_ports HD_GPIO_0] [get_bd_pins blink_led/blink_out]
  connect_bd_net -net debug_bridge_bscan_jtag_tdo [get_bd_pins debug_bridge_bscan/jtag_tdo] [get_bd_pins debug_bridge_inst/tap_tdo]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs debug_bridge_inst/S_AXI/Reg0] -force
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_network/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM]
